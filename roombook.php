        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                  ...
                  Room Booking 	       <div class ="black-text"><?php echo  $curdate; ?> </div>
                        </h1>
                    </div>
                        ...
                        <div class="panel-footer">
                            <form method="post">
										<div class="form-group">
														<label style="color: black;">Select the Conformation</label>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                         <div class = "black-text">  Available Room Details </div>
                        </div>
                        <div class="panel-body">
						<table width="200px">
											...
											{	
												...
												//echo "<script type='text/javascript'> window.location='home.php'</script>";
												 $type_of_room = 0;       
														...
														{
															$type_of_bed = $type_of_room * 4/15000;
														}
														else if($bed=="None")
														{
