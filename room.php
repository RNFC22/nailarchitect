        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a  class="active-menu" href="room.php"><i class="fa fa-plus-circle"></i>Add Time</a>
                    </li>
                    <li>
                        <a  href="roomdel.php"><i class="fa fa-desktop"></i> Delete Time</a>
                    </li>
						...
						<form name="form" method="post">
							...
							<?php
							 ...
							 if(isset($_POST['add']))
							 {
										...
										{
										 echo '<script>alert("New Time Added") </script>' ;
										}else {
